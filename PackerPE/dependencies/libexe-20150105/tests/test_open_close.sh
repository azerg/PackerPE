...
{ 
	...
	${TEST_RUNNER} ./${EXE_TEST_OPEN_CLOSE} ${INPUT_FILE};
...
EXE_TEST_OPEN_CLOSE="exe_test_open_close";

if ! test -x ${EXE_TEST_OPEN_CLOSE};
then
	EXE_TEST_OPEN_CLOSE="exe_test_open_close.exe";
fi

if ! test -x ${EXE_TEST_OPEN_CLOSE};
then
	echo "Missing executable: ${EXE_TEST_OPEN_CLOSE}";
