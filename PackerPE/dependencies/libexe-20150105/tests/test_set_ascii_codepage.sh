...
EXE_TEST_SET_ASCII_CODEPAGE="exe_test_set_ascii_codepage";

if ! test -x ${EXE_TEST_SET_ASCII_CODEPAGE};
then
	EXE_TEST_SET_ASCII_CODEPAGE="exe_test_set_ascii_codepage.exe";
fi

if ! test -x ${EXE_TEST_SET_ASCII_CODEPAGE};
then
	echo "Missing executable: ${EXE_TEST_SET_ASCII_CODEPAGE}";
...
do
	...
	${TEST_RUNNER} ./${EXE_TEST_SET_ASCII_CODEPAGE} ${CODEPAGE};
