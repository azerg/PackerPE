...
#if !defined( _LIBEXE_EXTERN_H )
#define _LIBEXE_EXTERN_H

/* To export functions from the libexe DLL define LIBEXE_DLL_EXPORT
 * To import functions from the libexe DLL define LIBEXE_DLL_IMPORT
