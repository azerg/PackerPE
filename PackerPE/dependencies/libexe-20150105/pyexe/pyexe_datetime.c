 ...
 */
PyObject *pyexe_datetime_new_from_fat_date_time(
           uint32_t fat_date_time )
{
	static char *function      = "pyexe_datetime_new_from_fat_date_time";
 ...
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyexe_datetime_new_from_filetime(
           uint64_t filetime )
{
	static char *function      = "pyexe_datetime_new_from_filetime";
	PyObject *date_time_object = NULL;
 ...
 * Returns a Python object if successful or NULL on error
 */
PyObject *pyexe_datetime_new_from_posix_time(
           uint32_t posix_time )
{
	static char *function      = "pyexe_datetime_new_from_posix_time";
	PyObject *date_time_object = NULL;
	uint16_t days_in_year      = 0;
	uint16_t year              = 0;
	uint8_t day_of_month       = 0;
